...
# 2. Правильный путь к базе данных (Исправление твоей ошибки)
basedir = os.path.abspath(os.path.dirname(__file__))
db_path = os.path.join(basedir, 'chat.db')  # <--- Вот переменная, которую мы потеряли!
...
class User(UserMixin, db.Model):
    ...
    def set_password(self, password):
        # Исправлено для совместимости с сервером
...
# Это гарантирует создание базы при запуске
